...
public class Eevee extends Pokemon implements NormalType {
   ...
   */
   public Eevee() {
      super("Evee", "Evee", 7, NORMAL_COLOR, 0.5, 9.0, 
   ...
   */
   public Eevee(String name) {
      super("Squirtle", name, 7, NORMAL_COLOR, 0.5, 9.0, 
        NORMAL_TYPE, "", BASE_ATTACK_POWER, 
        BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
      //pick Attacks
      chooseFastAttack();
   ...
   */
   protected Eevee(String species, String name, int num, 
      ...
      super(species, name, num, NORMAL_COLOR, ht, wt, 
        NORMAL_TYPE, "", baseAttackPwr, baseDefensePwr, baseStaminaPwr);
      //pick Attacks
